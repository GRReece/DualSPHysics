...
copy .\DtFixed.dat .\%dirout% 

copy .\CaseDambreak_PointsVelocity.txt .\%dirout% 
...
%measuretool% -dirin %dirout% -points XcelData.txt -onlytype:-all,+fluid -vars:-all,+vel.x, -savecsv %dirout%/ExcelData
if not "%ERRORLEVEL%" == "0" goto fail
