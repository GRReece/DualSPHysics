...
public:
  ...
  void SortBasicArrays(const unsigned *idp,const typecode *code,const unsigned *dcell,const double2 *posxy,const double *posz,const float4 *velrhop,const float *visc/*GRR*/,unsigned *idp2,typecode *code2,unsigned *dcell2,double2 *posxy2,double *posz2,float4 *velrhop2,float *visc2/*GRR*/);
  void SortDataArrays(const float4 *a,float4 *a2);
  void SortDataArrays(const float *a, float *a2);	/*GRR*/
  ...
  void SortDataArrays(const double2 *a,const double *b,const float4 *c,const float *d,double2 *a2,double *b2,float4 *c2, float *d2);	/*GRR*/
